...
namespace ITapTrade
{
	...
	public:
		...
		* @ingroup G_T_HKMarket
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL InsertHKMarketOrder(TAPIUINT32 *sessionID, TAPISTR_50 *ClientBuyOrderNo, TAPISTR_50 *ClientSellOrderNo, const TapAPIOrderMarketInsertReq *order) = 0;
		...
		* @ingroup G_T_HKMarket
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL CancelHKMarketOrder(TAPIUINT32 *sessionID, const TapAPIOrderMarketDeleteReq *order) = 0;
		...
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL OrderLocalRemove(TAPIUINT32 *sessionID, const TapAPIOrderLocalRemoveReq *order) = 0;
		/**
		* @brief 订单录入指令
		* @param[out] sessionID 返回当前请求的sessionID。
		...
		* @ingroup G_T_LocalActions
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL OrderLocalInput(TAPIUINT32 *sessionID, const TapAPIOrderLocalInputReq *order) = 0;
		/**
		* @brief 订单修改指令
		* @param[out] sessionID 返回当前请求的sessionID。
		...
		* @ingroup G_T_LocalActions
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL OrderLocalModify(TAPIUINT32 *sessionID, const TapAPIOrderLocalModifyReq *order) = 0;
		/**
		* @brief  订单转移指令
		* @param[out] sessionID 返回当前请求的sessionID。
		* @param[in] 订单转移请求信息。
		...
		* @ingroup G_T_LocalActions
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL OrderLocalTransfer(TAPIUINT32 *sessionID, const TapAPIOrderLocalTransferReq *order) = 0;
		/**
		* @brief 成交录入指令
		* @param[out] sessionID 返回当前请求的sessionID。
		* @param[in] 要录入的成交信息
		...
		* @ingroup G_T_LocalActions
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL FillLocalInput(TAPIUINT32 *sessionID, const TapAPIFillLocalInputReq *fill) = 0;
		/**
		* @brief 成交删除指令
		* @param[out] sessionID 返回当前请求的sessionID。
		* @param[in] 成交删除请求信息
		...
		* @ingroup G_T_LocalActions
		*/
		virtual TAP_DLLEXPORT ITapTrade::TAPIINT32 TAP_CDECL FillLocalRemove(TAPIUINT32 *sessionID, const TapAPIFillLocalRemoveReq *fill) = 0;
	};
};
