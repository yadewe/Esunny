...
public class doubleArray : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          QTapQuoteApiPINVOKE.delete_doubleArray(swigCPtr);
        }
  ...
  public doubleArray(int nelements) : this(QTapQuoteApiPINVOKE.new_doubleArray(nelements), true) {
  }

  public double getitem(int index) {
    double ret = QTapQuoteApiPINVOKE.doubleArray_getitem(swigCPtr, index);
    return ret;
  }

  public void setitem(int index, double value) {
    QTapQuoteApiPINVOKE.doubleArray_setitem(swigCPtr, index, value);
  }

  public SWIGTYPE_p_double cast() {
    global::System.IntPtr cPtr = QTapQuoteApiPINVOKE.doubleArray_cast(swigCPtr);
    SWIGTYPE_p_double ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_double(cPtr, false);
    return ret;
  }

  public static doubleArray frompointer(SWIGTYPE_p_double t) {
    global::System.IntPtr cPtr = QTapQuoteApiPINVOKE.doubleArray_frompointer(SWIGTYPE_p_double.getCPtr(t));
