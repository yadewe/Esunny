...
namespace QTapApiDemo
{
    public class TradeController
    {
        ...
        public int InitTradeAPI()
        {
            ...
            int iResult = -1;
            m_api = QTapTradeApi.CreateTapTradeAPI(appInfo, out iResult);
            if (m_api != null)
            {
                try
                {
        ...
        public void FreeApi()
        {
            ...
            if (m_api != null)
            {
                QTapTradeApi.FreeTapTradeAPI(m_api);
            }
        }

        public bool Login(string ip, ushort port, string username, string password)
        {
            m_api.SetHostAddress("123.161.206.213", 6060);
        ...
        private void TradeNotify_OnAPIReadyEvent()
        {
